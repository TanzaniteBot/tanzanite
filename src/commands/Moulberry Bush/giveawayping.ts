...
export default class GiveawayPingCommand extends BushCommand {
	...
	public async exec(message: Message): Promise<unknown> {
		...
		if (message.channel.id !== ('767782084981817344'|| '833855738501267456')) {return message.util.reply('<:no:787549684196704257> This command can only be run in <#767782084981817344>.');}
