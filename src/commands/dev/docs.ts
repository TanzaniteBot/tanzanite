			...
			if (c === null) {
				...
				if (c.props === undefined || c.methods === undefined) {
					const embed = new MessageEmbed()
						...
						.setFooter("For this class either there was not a single method or there wan not a single property. This caused me to exclude both, because if it didn't it would make the programmers' life much harder.")
